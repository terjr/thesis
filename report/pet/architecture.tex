...
by the input arguments. It's options have already been described in \autoref{sec:output},
and it's implementation is a simple nested if-else-clause that calls internal functions for

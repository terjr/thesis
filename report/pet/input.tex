...
PET has the ability to annotate it's output using a map from PC to function
...
The symbols extraction tool itself is actually just a simple script, it's source is printed

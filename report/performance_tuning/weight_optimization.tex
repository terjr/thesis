...
\begin{lstlisting}[caption={Algorithm used to generate individuals},label={lst:ga-create-algorithm},language=python,float]
...
\begin{lstlisting}[caption={Algorithm used to mutate individuals},label={lst:ga-mutate-algorithm},language=python,float]

...
\begin{figure}[htb]
    ...
    \caption{Overlay of PET training results (red) and training data (green) for the sha2-test.}
...
uncorrect. Wherever power is overestimated or underestimated depends on how

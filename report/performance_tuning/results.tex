...
have resonable values for the ALU operations (\texttt{IntAlu, IntMult, MemRead,
MemWrite, SimdFloatMisc}) with respect to the results found in
\cite{rundehvatum2013exploring}.  The values for the cache hierarcy
(\texttt{L1DR, L1DW, L1IR, L1IW, L2R, L2W}) does also seem advocate.
\texttt{PhysR} and \texttt{PhysW} are set to zero since the pyhsical memory of
...
about high bus activity while the ALU is ideling, as this often is the case

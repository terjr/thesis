...
\begin{abstract}
    ...
    growth, while energy efficiency affects both the power bill for
    ...
    Instruction level energy consumption are determined through measurements and
    ...
    Our method can be applied during the development process at the
    simulator level, while traditional methods typically involves hardware
    synthesis.  The results show that our tool can estimate energy consumption
    within 10~\% on general workloads, and is able to identify power consumption
